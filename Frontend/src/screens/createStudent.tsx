        ...
        <div >
            <form onSubmit={handleSubmit} className='flex gap-6 w-[1000px] items-center justify-between p-6 border rounded-md'>
                <div className='input-field'>
                    <label>Name:</label>
                    <input className='input' type="text" name="name" value={newStudent.name} onChange={handleInputChange} />
                </div>
                <div className='input-field'>
                    <label>Roll:</label>
                    <input type="number" className='input' name="roll" value={newStudent.roll.toString()} onChange={handleInputChange} />
                </div>
                <div className='input-field'>
                    <label>Address:</label>
                    <input type="text" className='input' name="address" value={newStudent.address} onChange={handleInputChange} />
                </div>
